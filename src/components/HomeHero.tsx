...
const HomeHero = () => {
  return (
    <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto rounded-3xl">
      ...
      <div className="aspect-[4/3] md:aspect-[3/2] lg:aspect-[4/3] h-auto mt-6 lg:mt-2">
        <picture className="w-full h-full block">
          <source
            type="image/webp"
            srcSet="/yosemite-small.webp 640w, /yosemite-medium.webp 1024w, /yosemite-large.webp 1600w"
            sizes="(min-width: 1024px) 50vw, 100vw"
          />
          <img
            src="/yosemite-small.jpg"
            srcSet="/yosemite-small.jpg 640w, /yosemite-medium.jpg 1024w, /yosemite-large.jpg 1600w"
            sizes="(min-width: 1024px) 50vw, 100vw"
